      ...
      <div class="row">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          ...
          >
            ...
            <template slot="route_name" slot-scope="props">
              <p>{{ props.row.route_name }}</p>
              <p>
                {{ dateFormated(props.row.departure_time, timeFormat.value) }} -
                {{ dateFormated(props.row.arrival_time, timeFormat.value) }}
              </p>
            </template>
            ...
            <template slot="dates" slot-scope="props">
              <b-container>
                <b-row>
                  <b-col
                    cols="2"
                    class="mr-4 mb-2 ml-2"
                    v-for="date in props.row.dates"
                    :key="date"
                  >
                    <b-badge variant="dark">{{
                      dateFormated(date, dateFormat.value)
                    }}</b-badge>
                  </b-col>
                </b-row>
              </b-container>
