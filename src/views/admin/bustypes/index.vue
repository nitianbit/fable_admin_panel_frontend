            ...
            <template slot="action" slot-scope="props">
              <span v-if="props.column.name == 'action'">
                ...
                >
                  ...
                  >
                  <b-dropdown-item :href="'#/bustype/' + props.row.ids"
...
export default {
  ...
  methods: {
        ...
        this.$swal
          ...
          .then((result) => {
            if (result.isConfirmed) {
              bustypeService.deleteBustype(id, name).then((response) => {
                if (
    ...
    loadItems() {
      bustypeService.getAll(this.queryParams).then((response) => {
        this.total_rows = response.data.totalRecords;
        this.rows = response.data.bustypes;
        this.showLoader = false;
      });
    },
    enableDropdowns() {
