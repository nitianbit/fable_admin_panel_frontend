                ...
                >
                  ...
                  <div class="wrapper text-center text-sm-left">
                    ...
                    <div class="fluid-container">
                      <h3 class="mb-0 font-weight-medium">3,000</h3>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card-col col-xl-3 col-lg-3 col-md-3 col-6">
              <div class="card-body">
                ...
                >
                  ...
                  ></i>
                  <div class="wrapper text-center text-sm-left">
                    <p class="card-text mb-0">New Agents</p>
                    <div class="fluid-container">
                      <h3 class="mb-0 font-weight-medium">350</h3>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card-col col-xl-3 col-lg-3 col-md-3 col-6">
              <div class="card-body">
                ...
                >
                  ...
                  ></i>
                  <div class="wrapper text-center text-sm-left">
                    <p class="card-text mb-0">New Drivers</p>
                    <div class="fluid-container">
