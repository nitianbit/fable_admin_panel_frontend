...
app.use(async (req, res, next) => {
  ...
  if (getSetting) {
    ...
    global.DEFAULT_DATEFORMAT = getSetting.general.date_format.value
      ? getSetting.general.date_format.value
      : "DD MMM YYYY";
    global.DEFAULT_TIMEFORMAT = getSetting.general.time_format.value
      ? getSetting.general.time_format.value
      : "hh:mm A";
  }
  next();
});
